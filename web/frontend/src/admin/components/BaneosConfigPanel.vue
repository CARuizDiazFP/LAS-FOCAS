<!--
  Nombre de archivo: BaneosConfigPanel.vue
  Ubicación de archivo: web/frontend/src/admin/components/BaneosConfigPanel.vue
  Descripción: Tab "Configuración" de /admin/Servicios/Baneos — config del worker de notificaciones Slack, estado del worker, envío manual y monitor de ingresos
-->
<template>
