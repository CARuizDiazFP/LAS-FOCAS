...
<template>
  <dialog ref="dialogEl" class="asociar-odf-modal" @click.self="handleClose" @cancel="handleCancelKey">
    <div class="modal-content">
      ...
      <CromoCaminoPanel :camino="camino" :servicio-id="props.servicioId">
        <template #odf-accion="{ odf }">
          <button
...
import CromoCaminoPanel from './CromoCaminoPanel.vue';
import {
  asociarServicioOdf,
...
/* Única regla del camino que se queda: el contenido de un slot se compila en el scope del
   padre, así que el `<style scoped>` de CromoCaminoPanel no alcanzaría a esta leyenda. */
