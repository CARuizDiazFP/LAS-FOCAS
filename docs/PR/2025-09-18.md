...
- Política de URL base actualizada: uso de IP privada de la VM (http://172.18.208.162:8080) en lugar de localhost.
...
- docs/web.md: agrega documentación de endpoints y seguridad; documenta roles Admin/OwnerGroup/Invitado.
 ...
 - Start: banner y verificación de /health ahora apuntan a http://172.18.208.162:8080.
