...
1. Restringir la publicación de `lasfocas-web` a `172.18.208.162:8080` en `deploy/compose.yml`.
...
- `lasfocas-web` sólo escucha en `172.18.208.162:8080` desde docker-compose.
