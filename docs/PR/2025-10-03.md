...
8. (Delta tardío) Refactor script `Start` para reinicio determinístico del stack mínimo con flags (`--purge`, `--rebuild-frontend`), health checks internos (NLP/Office), IP fija 172.18.208.162 y validaciones básicas de entorno.
