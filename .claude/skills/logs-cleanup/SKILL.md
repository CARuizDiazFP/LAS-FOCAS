...
# Ubicación de archivo: .claude/skills/logs-cleanup/SKILL.md
# Descripción: Skill para gestión y limpieza de archivos de log del proyecto y contenedores Docker (mirror de .agentes-comunes/skills/logs-cleanup/SKILL.md — fuente de verdad)
