...
# Ubicación de archivo: .agentes-comunes/skills/nocturne-token-compliance/SKILL.md
# Descripción: Habilidad para auditar y corregir espaciado/color hardcodeado en el frontend Vue 3 contra el tema Nocturne
...
argument-hint: "Vista o módulo de UI a auditar/corregir, por ejemplo: CamaraDetailView y sus modales"
---
