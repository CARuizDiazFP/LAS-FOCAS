...
# Ubicación de archivo: .agentes-comunes/skills/cromo-diagnostico-real/SKILL.md
# Descripción: Skill para validar contra la API/DB real de Cromo antes de confiar en el diseño documentado
