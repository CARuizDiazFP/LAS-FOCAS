...
# Ubicación de archivo: .agentes-comunes/skills/secrets-rollout/SKILL.md
# Descripción: Skill para migrar, agregar o rotar Docker Secrets file-based en dev y producción de LAS-FOCAS
