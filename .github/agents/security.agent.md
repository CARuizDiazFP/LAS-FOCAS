...
# Descripción: Agente orquestador de seguridad para APIs y SPAs Vue 3
...
argument-hint: "Describe revisión o fix de seguridad, por ejemplo: auditar CORS, XSS en Vue 3 y manejo seguro de tokens"
