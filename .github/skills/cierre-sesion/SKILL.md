...
# Ubicación de archivo: .github/skills/cierre-sesion/SKILL.md
# Descripción: Skill para retrospectiva técnica de cierre de sesión: tareas verificadas, errores, soluciones y mejoras agénticas de prevención y aceleración
