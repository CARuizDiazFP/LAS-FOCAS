---
name: "las-focas-nocturne-token-compliance"
...
# Ubicación de archivo: .codex-skills/skills/las-focas-nocturne-token-compliance/SKILL.md
# Descripción: Skill portable Codex migrada desde .github/skills/nocturne-token-compliance/SKILL.md
