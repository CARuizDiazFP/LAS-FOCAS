---
name: "las-focas-secrets-rollout"
...
- [docker-rebuild](../las-focas-docker-rebuild/SKILL.md) — comandos de rebuild/gestión de contenedores.
- [secret-detection](../las-focas-secret-detection/SKILL.md) — detección de secretos expuestos (auditoría, no rollout).
