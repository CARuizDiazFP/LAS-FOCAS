...
> Fuente original: `.agentes-comunes/skills/frontend-spa-architecture/SKILL.md`. Copia portable generada porque `.codex/` está montado como solo lectura en esta sesión.
