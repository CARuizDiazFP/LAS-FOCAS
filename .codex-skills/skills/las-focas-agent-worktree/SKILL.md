...
metadata:
  short-description: "Usar al INICIAR cualquier tarea y ante cualquier señal de concurrencia (otra sesión activa, trabajo largo, subagentes). ..."
  source: ".agentes-comunes/skills/agent-worktree/SKILL.md"
  triggers:
    - "agent-worktree"
    - "worktree"
    - "agente"
...
# Ubicación de archivo: .codex-skills/skills/las-focas-agent-worktree/SKILL.md
# Descripción: Skill portable Codex migrada desde .github/skills/agent-worktree/SKILL.md

# Skill portable: agent-worktree

> Fuente original: `.agentes-comunes/skills/agent-worktree/SKILL.md`. Copia portable generada porque `.codex/` está montado como solo lectura en esta sesión.
