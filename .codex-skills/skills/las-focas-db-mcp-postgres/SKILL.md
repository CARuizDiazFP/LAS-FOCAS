...
# Ubicación de archivo: .codex-skills/skills/las-focas-db-mcp-postgres/SKILL.md
# Descripción: Skill portable Codex migrada desde .github/skills/db-mcp-postgres/SKILL.md
