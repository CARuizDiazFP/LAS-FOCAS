# Nombre de archivo: skill-pytest-focas.md
# Ubicación de archivo: .gemini/rules/skill-pytest-focas.md
# Descripción: Regla Gemini portable migrada desde .github/skills/pytest-focas/SKILL.md
---
...
# Regla Skill: pytest-focas

> Fuente original: `.github/skills/pytest-focas/SKILL.md`. Usar esta regla cuando Gemini/Codex IDE detecte los triggers o globs declarados.
...
dedicada `.gemini/rules/skill-baneo-qa-real.md` antes de correr cualquier prueba de este tipo contra
`lasfocasdev-*`.
