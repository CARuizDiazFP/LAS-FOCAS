# Nombre de archivo: agent-bot-agent.md
# Ubicación de archivo: .gemini/rules/agent-bot-agent.md
# Descripción: Regla Gemini portable migrada desde .github/agents/bot.agent.md
---
name: "agent-bot-agent"
...
source: ".github/agents/bot.agent.md"
triggers:
  - "bot"
  - "agente"
  - "telegram"
...
# Regla Agente: Bot Agent

> Fuente original: `.github/agents/bot.agent.md`. Aplicar cuando el pedido coincida con esta automatización.
