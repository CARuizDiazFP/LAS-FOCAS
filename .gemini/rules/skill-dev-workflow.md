...
# Regla Skill: dev-workflow

> Fuente original: `.agentes-comunes/skills/dev-workflow/SKILL.md`. Usar esta regla cuando Gemini/Codex IDE detecte los triggers o globs declarados.
