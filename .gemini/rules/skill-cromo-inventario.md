# Nombre de archivo: skill-cromo-inventario.md
# Ubicación de archivo: .gemini/rules/skill-cromo-inventario.md
# Descripción: Regla Gemini portable migrada desde .github/skills/cromo-inventario/SKILL.md
---
...
# Regla Skill: cromo-inventario

> Fuente original: `.github/skills/cromo-inventario/SKILL.md`. Usar esta regla cuando Gemini/Codex IDE detecte los triggers o globs declarados.
...
1. Verificar contra `lasfocasdev-postgres` real (ver la regla `skill-db-mcp-postgres` sección
