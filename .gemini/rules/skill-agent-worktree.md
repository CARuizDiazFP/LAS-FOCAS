...
commands:
  ...
  - |
    python scripts/agent_worktree.py integrate --agent <id>
  - |
    python scripts/agent_worktree.py doctor
---

# Regla Skill: agent-worktree

> Fuente original: `.agentes-comunes/skills/agent-worktree/SKILL.md`. Usar esta regla cuando Gemini/Codex IDE detecte los triggers o globs declarados.
