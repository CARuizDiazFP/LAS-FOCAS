# Nombre de archivo: prompt-generar-pr-diario-prompt.md
# Ubicación de archivo: .gemini/rules/prompt-generar-pr-diario-prompt.md
# Descripción: Regla Gemini portable migrada desde .github/prompts/generar-pr-diario.prompt.md
---
name: "prompt-generar-pr-diario-prompt"
description: "Prompt migrado desde /home/support-focal-01/LAS-FOCAS/.github/prompts/generar-pr-diario.prompt.md"
source: ".github/prompts/generar-pr-diario.prompt.md"
triggers:
  - "generar-pr-diario-para-las-focas"
  - "generar-pr-diario-prompt"
  - "generar-pr-diario"
  - "migrado"
  - "home"
  - "support-focal-01"
...
# Regla Prompt: generar-pr-diario.prompt

> Fuente original: `.github/prompts/generar-pr-diario.prompt.md`. Usar como contrato reutilizable cuando el pedido coincida con esta automatización.
