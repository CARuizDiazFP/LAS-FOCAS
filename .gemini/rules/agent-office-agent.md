# Nombre de archivo: agent-office-agent.md
# Ubicación de archivo: .gemini/rules/agent-office-agent.md
# Descripción: Regla Gemini portable migrada desde .github/agents/office.agent.md
---
name: "agent-office-agent"
...
source: ".github/agents/office.agent.md"
triggers:
  - "office"
  - "agente"
  - "trate"
...
# Regla Agente: Office Agent

> Fuente original: `.github/agents/office.agent.md`. Aplicar cuando el pedido coincida con esta automatización.
