# Nombre de archivo: agent-testing-agent.md
# Ubicación de archivo: .gemini/rules/agent-testing-agent.md
# Descripción: Regla Gemini portable migrada desde .github/agents/testing.agent.md
---
...
source: ".github/agents/testing.agent.md"
triggers:
  - "testing"
  - "agente"
  - "trate"
...
# Regla Agente: Testing Agent

> Fuente original: `.github/agents/testing.agent.md`. Aplicar cuando el pedido coincida con esta automatización.
