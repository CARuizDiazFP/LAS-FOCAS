# Nombre de archivo: prompt-migracion-alembic-prompt.md
# Ubicación de archivo: .gemini/rules/prompt-migracion-alembic-prompt.md
# Descripción: Regla Gemini portable migrada desde .github/prompts/migracion-alembic.prompt.md
---
name: "prompt-migracion-alembic-prompt"
description: "Prompt migrado desde /home/support-focal-01/LAS-FOCAS/.github/prompts/migracion-alembic.prompt.md"
source: ".github/prompts/migracion-alembic.prompt.md"
triggers:
  - "crear-migraci-n-alembic"
  - "migracion-alembic-prompt"
  - "migracion-alembic"
  - "migrado"
  - "home"
  - "support-focal-01"
...
# Regla Prompt: migracion-alembic.prompt

> Fuente original: `.github/prompts/migracion-alembic.prompt.md`. Usar como contrato reutilizable cuando el pedido coincida con esta automatización.
