# Nombre de archivo: skill-sast-analysis.md
# Ubicación de archivo: .gemini/rules/skill-sast-analysis.md
# Descripción: Regla Gemini portable migrada desde .github/skills/sast-analysis/SKILL.md
...
# Regla Skill: sast-analysis

> Fuente original: `.agentes-comunes/skills/sast-analysis/SKILL.md`. Usar esta regla cuando Gemini/Codex IDE detecte los triggers o globs declarados.
